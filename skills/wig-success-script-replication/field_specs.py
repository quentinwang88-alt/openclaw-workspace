...
TABLE_SPECS: tuple[dict[str, Any], ...] = (
    {
        ...
        "fields": (
            ...
            {"name": "验证说明", "type": 1, "ui_type": "Text", "description": _description("【人工必填】简述成功依据，例如连续2条播放过万、最高2万+。")},
            ...
            {"name": "每产品生成数", "type": 2, "ui_type": "Number", "property": {"formatter": "0"}, "description": _description("【人工选填】填写1–20的累计目标总数，不是本轮新增数。已有3条后改填6，只补第4–6条；目标不变时不会重复生成。留空则同产品目标12条、跨产品目标4条。")},
    ...
    },
    {
        ...
        "fields": (
            ...
            {"name": "状态", "type": 3, "ui_type": "SingleSelect", "property": _options("待审核", "通过", "退回"), "description": _description("【人工审核】系统创建时为“待审核”；审核后改为“通过”或“退回”。")},
        ),
    },
)

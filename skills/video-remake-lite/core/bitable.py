...
FIELD_ALIASES = {
    ...
    "reference_images": ["复刻参考图", "参考图", "reference_images"],
    "person_reference_images": ["人物参考图", "person_reference_images"],
    "clothing_reference_images": ["服装参考图", "clothing_reference_images"],
    "scene_reference_images": ["场景参考图", "scene_reference_images"],
    "reference_requirements": ["参考要求", "reference_requirements"],
    "reference_input_mode": ["AI参考图素材模式", "reference_input_mode"],
    "reference_approval_mode": ["参考图审批模式", "reference_approval_mode"],
    "reference_action": ["参考图操作", "reference_action"],
    "reference_revision_notes": ["参考图修改意见", "reference_revision_notes"],
    "character_appearance_anchor": ["人物形象锚定", "character_appearance_anchor"],
    "character_identity_setting": ["人物族群与地域设定", "character_identity_setting"],
    "visual_lock_card": ["视觉锁定卡", "visual_lock_card"],
    "ai_reference_prompt": ["AI参考图提示词", "ai_reference_prompt"],
    "ai_reference_image": ["AI视频参考图", "ai_reference_image"],
    "reference_status": ["参考图状态", "reference_status"],
    "reference_version": ["参考图版本", "reference_version"],
    "reference_qa_result": ["参考图质检结果", "reference_qa_result"],
    "reference_input_fingerprint": ["参考输入指纹", "reference_input_fingerprint"],

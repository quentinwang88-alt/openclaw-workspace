...
JSON_COLUMNS = {
    ...
    "styling_templates": {
        "applicable_product_codes", "applicable_top_type", "applicable_product_type",
        "product_fit", "bottom_color", "bottom_fit", "vibe_tag",
        "supported_demonstration_modes", "scene_families", "visibility_zones",
        "preferred_persona_ids", "outfit_recipe", "source_payload",
    },
...
JSON_OBJECT_COLUMNS = {
    ...
    "expected_tags", "observed_tags", "outfit_recipe",
}
...
CREATE TABLE IF NOT EXISTS styling_templates (
    ...
    vibe_tag TEXT,
    target_role TEXT NOT NULL DEFAULT 'TARGET_GARMENT',
    supported_demonstration_modes TEXT NOT NULL DEFAULT '[]',
    scene_families TEXT NOT NULL DEFAULT '[]',
    preferred_persona_ids TEXT NOT NULL DEFAULT '[]',
    style_intensity TEXT NOT NULL DEFAULT '',
    climate_profile TEXT NOT NULL DEFAULT '',
    silhouette_key TEXT NOT NULL DEFAULT '',
    outfit_recipe TEXT NOT NULL DEFAULT '{}',
    base_outfit_direction TEXT NOT NULL DEFAULT '',
    hair_direction TEXT NOT NULL DEFAULT '',
    neckline_direction TEXT NOT NULL DEFAULT '',
    outer_layer_direction TEXT NOT NULL DEFAULT '',
    palette_relation TEXT NOT NULL DEFAULT '',
    visibility_zones TEXT NOT NULL DEFAULT '[]',
    visibility_requirement TEXT NOT NULL DEFAULT '',
    finish_direction TEXT NOT NULL DEFAULT '',
    prompt_core TEXT NOT NULL,
    notes TEXT NOT NULL DEFAULT '',
    created_at TEXT NOT NULL,
    updated_at TEXT NOT NULL

...
function buildTaskContext(record, config) {
  ...
  return {
    ...
    resolution: normalizeTextField(fields[config.fields.resolution || '分辨率']),
    taskSource: normalizeTextField(fields[config.fields.taskSource || '任务来源']),
    firstFrameStrategy: normalizeTextField(fields[config.fields.firstFrameStrategy || '首帧策略']),
    repeatTarget,
    submittedCount,

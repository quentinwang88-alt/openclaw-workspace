...
class ErrorCode(str, Enum):
    ...
    CATEGORY_INFERENCE_FAILED = "CATEGORY_INFERENCE_FAILED"
    ...
    DESCRIPTION_COUNT_UNAVAILABLE = "DESCRIPTION_COUNT_UNAVAILABLE"
    DESCRIPTION_LIMIT_EXCEEDED = "DESCRIPTION_LIMIT_EXCEEDED"
    PREFLIGHT_FAILED = "PREFLIGHT_FAILED"
    PUBLISH_PENDING_VERIFICATION = "PUBLISH_PENDING_VERIFICATION"

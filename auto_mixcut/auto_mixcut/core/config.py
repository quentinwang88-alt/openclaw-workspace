...
class Settings:
    ...
    def load(cls, config_path: str | None = None) -> "Settings":
        ...
        return cls(
            ...
            aliyun_access_key_id=str(data.get("aliyun_access_key_id") or _env_first("AUTO_MIXCUT_ALIYUN_ACCESS_KEY_ID", "ALIYUN_OSS_ACCESS_KEY_ID")).strip(),
            aliyun_access_key_secret=str(data.get("aliyun_access_key_secret") or _env_first("AUTO_MIXCUT_ALIYUN_ACCESS_KEY_SECRET", "ALIYUN_OSS_ACCESS_KEY_SECRET")).strip(),

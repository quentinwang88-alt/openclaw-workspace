...
def resolve_table_args(args: argparse.Namespace) -> Tuple[str, str]:
    if args.app_token and args.table_id:
        return args.app_token, args.table_id
    ...
    return resolved_app_token, info.table_id
...
def main() -> int:
    ...
    app_token, table_id = resolve_table_args(args)
    ...
    records = client.list_records(limit=args.limit)
